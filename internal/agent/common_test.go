...
func coderAgent(r *vcr.Recorder, env fakeEnv, large, small fantasy.LanguageModel) (SessionAgent, error) {
	...
	allTools := []fantasy.AgentTool{
		...
		tools.NewEditTool(nil, tools.NewEditGuard(), env.permissions, env.history, *env.filetracker, env.workingDir),
		tools.NewMultiEditTool(nil, tools.NewEditGuard(), env.permissions, env.history, *env.filetracker, env.workingDir),
