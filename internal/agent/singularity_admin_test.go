...
func TestDiffAndResetSingularityPolicies(t *testing.T) {
	...
	trace := manager.FinishTurn("diff-1", "completed", "first policy version")
	require.NotNil(t, trace)
	manager.CompileTurn(context.Background(), trace)
	...
	trace = manager.FinishTurn("diff-2", "completed", "second policy version")
	require.NotNil(t, trace)
	manager.CompileTurn(context.Background(), trace)
...
func TestListSingularityAuditReturnsRecentRecords(t *testing.T) {
	...
	trace := manager.FinishTurn("audit-1", "completed", "recovered after blocking bash")
	require.NotNil(t, trace)
	manager.CompileTurn(context.Background(), trace)
