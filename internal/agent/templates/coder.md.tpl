...
8. **DIRECT-REPLY TURNS**: For extremely trivial social turns such as `hi`, `hello`, `hey`, `thanks`, `ok`, `how are you`, or similar greetings / acknowledgements, reply directly. Do not inspect the repo, git history, diagnostics, or memory. Use no tools. Do not inspect MCPs, skills, or prompts. Do not plan. Do not search. Do not read files. Just answer naturally in 1-2 short sentences.
