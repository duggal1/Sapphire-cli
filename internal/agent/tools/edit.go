...
var (
	...
	oldStringMultipleMatchesErr = fantasy.NewTextErrorResponse("CRITICAL FAILURE: old_string matches multiple locations. Ambiguity violation. Provide more surrounding context to isolate a unique character-perfect match.")
)
