...
func TestConfig_setupAgentsWithDisabledTools(t *testing.T) {
	...
	assert.Equal(t, []string{"agent", "spawn_agent", "resume_agent", "send_input", "wait", "collect_result", "close_agent", "spawn_agents_on_csv", "report_agent_job_result", "orchestrate_worktrees", "bash", "agent_mail_send", "agent_mail_inbox", "agent_mail_ack", "agent_directory", "check_hook", "job_output", "job_kill", "agentic_edit", "lsp_diagnostics", "lsp_references", "lsp_restart", "fetch", "agentic_fetch", "web_search", "web_fetch", "glob", "rg", "rg_files", "ls", "wc", "wc_l", "view_memory", "refresh_memory", "recall_memory", "save_memory", "sourcegraph", "python", "update_plan", "request_user_input", "set_mode", "view", "single_view", "agentic_view", "apply_patch", "write", "list_tools", "search_tools", "tool_search", "run_harness", "search_skills", "install_skill", "index_codebase", "tool_suggest", "list_available_mcps", "install_mcp", "connect_mcp", "call_mcp_tool", "list_mcp_tools", "list_mcp_resources", "read_mcp_resource", "load_skill", "list_skills"}, coderAgent.AllowedTools)
...
func TestConfig_setupAgentsWithEveryReadOnlyToolDisabled(t *testing.T) {
	...
	coderAgent, ok := cfg.Agents[AgentCoder]
	require.True(t, ok)
	assert.Equal(t, []string{"agent", "spawn_agent", "resume_agent", "send_input", "wait", "collect_result", "close_agent", "spawn_agents_on_csv", "report_agent_job_result", "orchestrate_worktrees", "bash", "agent_mail_send", "agent_mail_inbox", "agent_mail_ack", "agent_directory", "check_hook", "job_output", "job_kill", "download", "edit", "single_edit", "agentic_edit", "lsp_diagnostics", "lsp_references", "lsp_restart", "fetch", "agentic_fetch", "web_search", "web_fetch", "rg", "rg_files", "wc", "wc_l", "view_memory", "refresh_memory", "recall_memory", "save_memory", "python", "update_plan", "request_user_input", "set_mode", "agentic_view", "apply_patch", "write", "list_tools", "search_tools", "tool_search", "run_harness", "search_skills", "install_skill", "index_codebase", "tool_suggest", "list_available_mcps", "install_mcp", "connect_mcp", "call_mcp_tool", "list_mcp_tools", "list_mcp_resources", "read_mcp_resource", "load_skill", "list_skills"}, coderAgent.AllowedTools)
