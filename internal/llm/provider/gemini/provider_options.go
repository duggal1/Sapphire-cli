...
type ProviderOptions struct {
	...
	// Optional. Enable Google search grounding tool.
	GoogleSearch *bool `json:"google_search,omitempty"`
	// Optional. Enable code execution tool.
...
// GroundingChunkWeb represents a web grounding chunk from Google.
type GroundingChunkWeb struct {
	URI   string `json:"uri,omitempty"`
	Title string `json:"title,omitempty"`
}

// GroundingChunk represents a grounding chunk from Google.
type GroundingChunk struct {
	Web *GroundingChunkWeb `json:"web,omitempty"`
}

// GroundingMetadata represents grounding metadata from Google.
