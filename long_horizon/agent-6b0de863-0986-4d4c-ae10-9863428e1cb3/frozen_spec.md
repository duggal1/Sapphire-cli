# Frozen Spec (Session agent-6b0de863-0986-4d4c-ae10-9863428e1cb3)

## Task Definition
You are a dedicated sub-agent. Execute the assignment below autonomously.

Assignment ID: subagent-1773596339759811000
...
Task instruction:
Analyze the domain: TUI. Analyze internal/ui/ for Bubble Tea v2 patterns. Use agentic_view to read files.

Input row (JSON):
{
  "domain": "TUI",
  "instructions": "Analyze internal/ui/ for Bubble Tea v2 patterns."
}
