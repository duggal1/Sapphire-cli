# Frozen Spec (Session agent-aea9317a-a504-4e30-81f7-60dceddaec43)
...
Assignment ID: lh:e549dad7-671a-41ec-93ac-42f533926119:m2
Parent session: e549dad7-671a-41ec-93ac-42f533926119
Title: Implement task
Workdir: /Users/harshitduggal/workspace/sapphire-cli
Domains: testing, docs, infra

Task:
Long-horizon milestone execution.

Milestone: Implement task
Completion condition: Changes implemented per spec; local checks/tests pass.
...
- Worktree orchestration: `orchestrate_worktrees` is a batch helper for pre-scoped parallel worktrees. Do not use it when the task is about real sub-a…
